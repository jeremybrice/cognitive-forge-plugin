...
```
claude plugins add jeremybrice/product-forge-plugin/productivity
```
...
| `/setup-org` | Configure your product taxonomy — products, modules, clients, integrations, and teams |
...
| `org-context` | Organizational taxonomy storage — products, modules, clients, integrations in memory/context/ with YAML frontmatter |
